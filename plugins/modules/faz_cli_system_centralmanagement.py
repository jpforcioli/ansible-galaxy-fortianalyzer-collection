...
DOCUMENTATION = '''
---
module: faz_cli_system_centralmanagement
short_description: Central management configuration.
description:
...
def main():
    ...
    perobject_jrpc_urls = [
        '/cli/global/system/central-management/{central-management}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'cli_system_centralmanagement'),
