...
DOCUMENTATION = '''
---
module: faz_cli_system_logforwardservice
short_description: Log forwarding service.
description:
        ...
        suboptions:
            accept-aggregation:
                ...
                choices:
                    - 'disable'
                    - 'enable'
            aggregation-disk-quota:
                type: int
                default: 20000
                description: 'Aggregated device disk quota (MB) on server.'
...
def main():
    ...
    perobject_jrpc_urls = [
        '/cli/global/system/log-forward-service/{log-forward-service}'
    ]
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'cli_system_logforwardservice'),
