...
DOCUMENTATION = '''
---
module: faz_cli_system_admin_user_policypackage
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'cli_system_admin_user_policypackage'),
